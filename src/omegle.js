...
const arrTopics = (`undefined` !== typeof process.argv[2]) ?
        process.argv[2].split(`,`) :
        config.likes,
    endpoint = `http://front2.omegle.com`,
    randid = (Math.floor(Math.random() * 1000000000 + 1000000000)).toString(36).toUpperCase(;

const getLoginURL = (randid, arrTopics) => endpoint + '/start?' + querystring.encode({
    rcs: 1,
    firstevents: 1,
    spid: ``,
    randid,
...
const postPromise = (url, data) => new Promise(
